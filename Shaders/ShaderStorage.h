...
// usually I avoid including this in header files because it is so large, but the interested 
// party must have access to GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, etc.
